...
try {
    ...
    const renames = [
        ['src/components/vendor/CutzoHeader.tsx', 'src/components/vendor/CutzoHeader.tsx'],
        ['src/components/cutzo', 'src/components/cutzo'],
        ['android/app/src/main/java/com/cutzo', 'android/app/src/main/java/com/cutzo']
    ];
